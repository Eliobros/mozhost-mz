      ...
      items: [
        {
          ...
          color: Colors.primary,
          onPress: () => openLink('https://mozhost.topaziocoin.online/docs'),
        },
        {
          icon: 'logo-youtube',
      ...
      items: [
        {
          ...
          onPress: () => openLink('https://mozhost.topaziocoin.online/#terms'),
        },
        {
          icon: 'shield-checkmark',
          label: 'Política de Privacidade',
          color: Colors.textSecondary,
          onPress: () => openLink('https://mozhost.topaziocoin.online/#privacy'),
        },
      ],
    },
  ];
