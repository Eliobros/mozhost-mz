    ...
    <div className="bg-white rounded-lg shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-200">
      <div className="p-6">
        ...
        <div className="space-y-3 mb-6">
          ...
          {/* MySQL Credentials (apenas para PHP) */}
          {container.type === 'php' && container.db_name && (
            <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-1">
                    <code className="bg-white px-2 py-1 rounded border border-blue-200">{container.db_name}</code>
                    <button
                      onClick={() => copyToClipboard(container.db_name, 'Nome do banco')}
                      className="p-1 hover:bg-blue-100 rounded"
                      title="Copiar banco"
                    >
                      <Copy className="w-3 h-3 text-blue-700" />
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-1">
                    <code className="bg-white px-2 py-1 rounded border border-blue-200">{container.db_user}</code>
                    <button
                      onClick={() => copyToClipboard(container.db_user, 'Usuário')}
                      className="p-1 hover:bg-blue-100 rounded"
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      onClick={() => copyToClipboard(container.db_password, 'Senha')}
                      className="p-1 hover:bg-blue-100 rounded"
                      title="Copiar senha"
                    >
                      <Copy className="w-3 h-3 text-blue-700" />
              ...
              {container.pma_domain && (
                <div className="mt-3 pt-2 border-t border-blue-200">
                  <a 
                    href={`http://${container.pma_domain}`} 
                    target="_blank" 
                    rel="noopener noreferrer"
