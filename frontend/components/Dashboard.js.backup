    ...
    <div className="space-y-6 p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <div className="inline-flex items-center bg-yellow-100 text-yellow-900 px-3 py-1 rounded-md">
                <span className="text-sm font-semibold">💰 Coins: {coins}</span>
              </div>
              <a
                href="#coins"
                className="inline-flex items-center bg-green-600 text-white px-3 py-1 rounded-md hover:bg-green-700 transition-colors text-sm font-semibold"
              >
                💳 Comprar Coins
              </a>
              {!whatsappLinked && (
                <a
                  href="#whatsapp"
                  className="inline-flex items-center bg-white text-green-600 px-3 py-1 rounded-md hover:bg-gray-100 transition-colors text-sm font-semibold"
                >
              ...
              {whatsappLinked && (
                <div className="inline-flex items-center bg-green-100 text-green-800 px-3 py-1 rounded-md text-sm font-semibold">
      ...
      {!whatsappLinked && (
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-lg p-4">
          <div className="flex items-start">
            <MessageCircle className="w-6 h-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-green-900 mb-1">
                🚀 Gerencie tudo pelo WhatsApp!
              </h3>
              <p className="text-sm text-green-800 mb-3">
                Vincule sua conta ao WhatsApp e tenha acesso a:
              </p>
              <ul className="text-sm text-green-700 space-y-1 mb-3">
                <li>✅ Comprar coins sem sair do WhatsApp</li>
                <li>✅ Ver saldo e status dos containers</li>
                <li>✅ Iniciar, parar e reiniciar bots</li>
                <li>✅ Receber notificações instantâneas</li>
              </ul>
              <a
                href="#whatsapp"
                className="inline-flex items-center bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition-colors text-sm font-semibold"
              >
      ...
      {storageAlerts.length > 0 && (
        <div className="bg-orange-50 border border-orange-200 text-orange-800 rounded-md p-4">
          <div className="font-semibold mb-1">⚠️ Armazenamento quase cheio</div>
